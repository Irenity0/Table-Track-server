...
// middleware
app.use(cors({
  origin: ["https://bistro-boss-35891.web.app", "https://bistro-boss-35891.firebaseapp.com"],
  credentials: true
  })
);
  ...
  try {
    ...
    const verifyToken = (req,res,next) => {
      ...
      if(!req.headers.authorization) {
        return res.status(401).send({message: `forbidden access you bum`});
      }
    ...
    app.get('/admin-stats', verifyToken, verfiyAdmin, async(req,res) => {
      ...
      res.send({users, menuItems, totalRevenue});
    })
